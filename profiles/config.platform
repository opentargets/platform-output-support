...
gs_sync_from        = "open-targets-pre-data-releases/22.11"
is_partner_instance = false

# Variable for creating IMAGES : ElasticSearch and Clickhouse
config_direct_json  = "open-targets-pre-data-releases/22.11/input"
config_gs_etl       = "open-targets-pre-data-releases/22.11/output"
