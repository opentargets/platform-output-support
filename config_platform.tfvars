...
release_id_dev                            = "22.11.2"
release_id_prod                           = "22.11"
gs_sync_from                              = "open-targets-pre-data-releases/22.11.2"
is_partner_instance                       = false

# Variable for creating IMAGES : ElasticSearch and Clickhouse
config_direct_json                         = "open-targets-pre-data-releases/22.11.2"
config_gs_etl                              = "open-targets-pre-data-releases/22.11.2/output"
