...
export pos_data_release_path_metadata_root="$${pos_data_release_sekeleton_path_metadata_root}"
...
export pos_data_disk_tarball_elastic_earch="${POS_DATA_DISK_TARBALL_ELASTIC_SEARCH}"
