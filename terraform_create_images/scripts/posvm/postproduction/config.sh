...
export pos_elasticsearch_docker_image=${POS_ELASTICSEARCH_DOCKER_IMAGE}
export pos_elasticsearch_docker_image_version=${POS_ELASTICSEARCH_DOCKER_IMAGE_VERSION}
